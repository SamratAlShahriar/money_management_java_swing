...
//        table.addRow(new Object[]{"Kevin Pietersen", "kevinpietersen@gmail.com", "Admin", "25 Apr,2018", StatusType.PENDING});
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SL", "Date", "Transaction Type", "Amount", "Note"
            }
        ) {
    ...
    public void displayDatasWithinTable() {
        ...
        List<TransactionModel> trList = transactionRepository.getAllTransactionList(6);
        ...
        for (int i = 0; i < trList.size(); i++) {
            ...
            row[2] = tt.name();
            row[3] = String.valueOf(tm.getAmount());
            row[4] = tm.getNote();
            table.addRow(row);
        }
    ...
    private void populateHomeData() {
        TransactionRepository transactionRepository = new TransactionRepository();
        SummaryModel sm = transactionRepository.getSummary(Session.getUserModel().getId());

        card1.setData(new Model_Card(new ImageIcon(getClass()
                .getResource("/shorna/moneymanagement/images/stock.png")), "Income", "৳"+sm.getTotalIncome(), ""));
        
        card2.setData(new Model_Card(new ImageIcon(getClass()
                .getResource("/shorna/moneymanagement/images/profit.png")), "Expense", "৳"+sm.getTotalExpense(), ""));
