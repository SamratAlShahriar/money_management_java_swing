...
public class Expense extends javax.swing.JPanel {
    ...
    public void displayDatasWithinTable() {
        ...
        trList = transactionRepository.getAllExpenseTransactionList(userId);
    ...
    private void initComponents() {
        ...
        cmbCategory.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Category", "Food", "Shopping", "House Rent", "Electricity Bill", "Gas Bill", "Miscellaneous", "Travel Fare", "Others", " " }));
        ...
        panelBorder1.setPreferredSize(new java.awt.Dimension(882, 358));
        ...
        panelBorder1Layout.setVerticalGroup(
            ...
            .addGroup(panelBorder1Layout.createSequentialGroup()
                .addComponent(jLabel2)
                .addGap(0, 0, 0)
                .addComponent(spTable, javax.swing.GroupLayout.DEFAULT_SIZE, 363, Short.MAX_VALUE))
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(10, 10, 10)
                .addComponent(panelBorder1, javax.swing.GroupLayout.PREFERRED_SIZE, 387, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        if (selectedModel == null) {
            ...
            if (isUpdated) {
                resetFields();
                selectedModel = null;
                PopUpMessage.popUpMsgBox("Expense data updated!", "Success", WIDTH);
                DashboardPage.instance.refreshAllData();
    ...
    private void btnDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteMouseClicked
        if (selectedModel == null) {
            ...
            if (isUpdated) {
                resetFields();
                selectedModel = null;
                PopUpMessage.popUpMsgBox("Expense data deleted!", "Success", WIDTH);
                DashboardPage.instance.refreshAllData();
